...
function Login({ show, handleCloseLogin,showReg }) {
  ...
  return (
    <Modal show={show} onHide={() => handleCloseLogin()} className="TextLogin">
      ...
      <p className="text-center blurText">
        Don't have an account? Click <span onClick={() => handleRegister()} className="otherblurtext" style={{cursor:'pointer'}}>Here</span>{" "}
      </p>
    </Modal>
  );
}
